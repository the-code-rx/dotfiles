...
function generate_inactive_window_string() {
  ...
  echo "${separator_start}#[fg=${PALLETE[fg_gutter]},bold]#I${separator_internal}#[fg=${PALLETE[fg_gutter]}] #{?window_zoomed_flag, , }#W ${separator_end}"
}
...
function generate_active_window_string() {
  ...
  echo "${separator_start}#[fg=${PALLETE[fg_gutter]},bold]#I${separator_internal}#[fg=${PALLETE[fg_gutter]}] #{?window_zoomed_flag, , }#W ${separator_end}#[none]"
}
