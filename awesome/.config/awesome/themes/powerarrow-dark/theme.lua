...
theme.wallpaper = "~/Pictures/wallpapers/kanji-with-blobs_00_1920x1080.png"
theme.font = "JetBrainsMono Nerd Font 3.5"
theme.fg_normal = "#a9b1d6"
theme.fg_focus = "#92ce6a"
...
clock.valign = "center"
clock.font = "JetBrainsMono Nerd Font 3.5"

-- Calendar
theme.cal = lain.widget.cal({
	attach_to = { clock },
	notification_preset = {
		font = "JetBrainsMono Nerd Font 3",
		fg = theme.fg_normal,
		bg = theme.bg_normal,
	},
})
...
local mem = lain.widget.mem({
	settings = function()
		widget:set_markup(markup.font(theme.font, "󱒌 " .. mem_now.used .. "MB  "))
	end,
})
...
function theme.at_screen_connect(s)
	...
	-- Create the wibox
	s.mywibox =
		awful.wibar({ position = "top", screen = s, height = dpi(9), bg = theme.bg_normal, fg = theme.fg_normal })
