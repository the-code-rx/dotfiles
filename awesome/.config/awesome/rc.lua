...
globalkeys = mytable.join(
	...
	-- Standard program
	awful.key({ altkey, "Control", "Shift" }, "t", function()
	...
	-- Lauch Discord
	awful.key({ altkey, "Control", "Shift" }, "i", function()
		awful.spawn("code --profile JoeyV")
	end, { description = "run Discord", group = "launcher" }),
	-- Lauch Vs Code
	awful.key({ altkey, "Control", "Shift" }, "d", function()
		awful.spawn("discord")
	end, { description = "run Vs Code", group = "launcher" }),
	--Launch Slack
	awful.key({ altkey, "Control", "Shift" }, "s", function()
		awful.spawn("slack")
	end, { description = "run Slack", group = "launcher" }),
	--Launch Gmail
	awful.key({ altkey, "Control", "Shift" }, "g", function()
		awful.spawn("gmail-desktop")
	end, { description = "run Gmail", group = "launcher" }),
	-- Lauch Gmail
	awful.key({ altkey, "Control", "Shift" }, "o", function()
		awful.spawn("obs")
	end, { description = "run OBS", group = "launcher" }),
	awful.key({ altkey, "Control", "Shift" }, "e", function()
		awful.spawn("zoho-mail-desktop")
	end, { description = "run Zoho", group = "launcher" }),
	-- Launch Zoho
	awful.key({ altkey, "Control", "Shift" }, "z", function()
		awful.spawn("zeal")
	end, { description = "run Zeal", group = "launcher" }),
...
clientkeys = mytable.join(
	...
	awful.key({ altkey, "Shift", "Control" }, "w", function(c)
		c:kill()
